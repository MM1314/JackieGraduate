...
public class DetectHandView extends SampleBase {

    	private static final String   TAG = "Sample::DetectHandView";
	    private Mat                   mRgba;
	    private Mat                   mGray;
	    ...
	    public static final Scalar   HAND_RECT_COLOR = new Scalar(0, 255, 0, 255);
	    public static final Scalar HAND_RECT_CAMSHIFT_COLOR = new Scalar(0, 0, 255, 255);
	    ...
	    public DetectHandView(Context context) {
	    	super();
	        try {
	            mGray = new Mat();
	            mRgba = new Mat();
	    ...
	    protected Bitmap processFrame(VideoCapture capture) {
	        ...
	        if(!nextFrame){//nextFrame = false
	        	...
	        	if(curr_area < 3.5 * handArea && curr_area > 0.5 * handArea){
	        		Core.ellipse(mRgba, hand_box, DetectHandView.HAND_RECT_CAMSHIFT_COLOR, 6);
