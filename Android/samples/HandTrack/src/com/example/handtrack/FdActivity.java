...
public class FdActivity extends Activity {
    		...
    		switch (status) {
				case LoaderCallbackInterface.SUCCESS:
				{
					...
					if( !mView.openCamera() ) {
						...
						//ad.setButton2("OK", new DialogInterface.OnClickListtener(){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item == mItemFace50)
        	...
        	mView.nextFrame=true;
        	//{
        	//mView.hp.hpstatus=mView.hp.hpstatus.NONE;
        	//mView.isHeadPoseOn=1;
        	//}
