...
private:
  ...
  cv::Size window_size;
  int level;
  //The original Function Paragram Type:: OutputArray status
  std::vector<uchar> status;
 
  std::vector<uchar> FB_status;
   //The original Function Paragram Type:: Output vector that contains the difference between patches around the original and  moved points. 
