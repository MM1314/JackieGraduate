...
public class ACDsee extends Activity implements
	...
	private GalBroadcastReceiver receiver;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//add by Jackie on 20141211 注册广播
		receiver = new GalBroadcastReceiver(g);
	...
	private List<String> getImagesFromSD() {
		...
		if(files == null || files.length == 0){
			Log.e("Jackie", "no files  exist in the subfile~~");
			return imageList;
		}
